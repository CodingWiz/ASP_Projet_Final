...
<body>
        ...
        <div id="divConnexion" runat="server">
            ...
            <table>
                ...
                <tr>
                    ...
                    <asp:Label runat="server" CssClass="erreur">
                     ...
                     ErrorMessage="Le mot de passe doit être défini!" />
                         ...
                         <asp:RangeValidator ID="rangeMDP" runat="server"
                             ControlToValidate="tbMDP"
                             EnableClientScript="false"
                             Display="dynamic"
                             Type="Integer"
                              ErrorMessage="Le mot de passe doit être un nombre entre 11111 et 99999!"
                             MaximumValue="99999" MinimumValue="11111" />
                        </asp:Label>
                    </td>
                ...
                <tr>
                    <td class="erreur"><asp:Label runat="server" ID="lblErreurSQL"></asp:Label></td>
                </tr>
            </table>
